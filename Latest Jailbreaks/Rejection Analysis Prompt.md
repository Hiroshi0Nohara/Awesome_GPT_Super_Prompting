...
## NOTES 
replace original malicious statement with your statement within being bracket.
the prompt will provide you with the prompt which would be better and if your prompt was malicious then it will provide a subtle prompt which will then me used in chatgpt again to get the required responses. 
and
if any error seen type like the ai response being deleted use copy paste below lines :
